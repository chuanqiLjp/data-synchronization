...
[android 中有哪几种解析xml的类？官方推荐哪种？以及它们的原理和区别](#android 中有哪几种解析xml的类？官方推荐哪种？以及它们的原理和区别)
...
<h2 id="ListView优化方案">ListView优化方案<a href="http://blog.csdn.net/fenghai22/article/details/44173057" >(更多参考)</a></h2>
...
<h2 id="android 中有哪几种解析xml的类？官方推荐哪种？以及它们的原理和区别">
...
# 20、StringBuilder与 StringBuffer的区别
```
...
# 22、View的绘制流程[更多参考](http://blog.csdn.net/yanbober/article/details/46128379/)
```
measure过程
